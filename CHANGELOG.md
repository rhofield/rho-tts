...
- Add opt-in adjacent speech continuity validation with explicit per-call context, shared candidate retries, and structured results through isolated providers.
